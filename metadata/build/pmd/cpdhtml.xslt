...
<body>
 <H1><div class="top"><div class="left">iDART PMD-CPD Report</div></div></H1>
    <p><a href="http://trac.cell-life.org/iDART">iDART Trac environment</a></p>
    <hr/>
        	...
        	<td>
        		<table>
        			<xsl:for-each select="file">
        				<tr><td><xsl:value-of select="@path"/></td><td> line <xsl:value-of select="@line"/></td></tr>
        			</xsl:for-each>
        		</table>
        	</td>
