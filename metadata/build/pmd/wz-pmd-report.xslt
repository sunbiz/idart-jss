...
<body>
    <H1><div class="top"><div class="left">iDART PMD <xsl:value-of select="//pmd/@version"/> Report</div><div class="right"><xsl:call-template name="timestamp"/></div></div></H1>
    <p><a href="http://trac.cell-life.org/iDART">iDART Trac environment</a></p>
    <hr/>
    Single listing<br/>
    <a href="pmd-report-per-class.html">Listing per class</a>
    <h2>Summary</h2>
